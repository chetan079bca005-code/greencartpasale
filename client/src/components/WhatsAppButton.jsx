...
const WhatsAppButton = () => {
    ...
    const message = encodeURIComponent("Hello! I'm interested in your products on GreenCart.");
    ...
    return (
        ...
        >
            ...
            {/* Tooltip */}
            <span className="absolute right-16 bg-slate-800 text-white text-sm px-3 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-lg">
                Chat with Seller
            </span>
        </button>
    );
